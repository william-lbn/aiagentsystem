...
- Cross-host canonical hash workflow for Ubuntu 22.04/24.04.
...
- 462-page book, 164-page workbook, 127-page website and 90-slide deck.
- Six scoped L5 evidence packages and 100 external source locks.
- Two isolated same-host cold rebuilds with 134 canonical artifacts byte-equivalent.

### Known evidence limits

- SWE-bench Lite and WebArena are not executed in this release and have no published score.
- Cross-host canonical, real provider/browser/cloud E2E and all ten broad upstream contracts are not claimed as verified.
